...
def SUPstat(train_data,test_data,Z_2_train,n_lr,k=5,n_layer=3,n_node=64,n_epoch=200,seed=1924):  
    set_seed(seed)
    #1.basic set-ups
...
def SUPtest(train_data,test_data,alpha=0.05,n_lr=4e-4,n_layer=3,n_node=64,n_epoch=200,k=5,B=50,seed=1924):
    set_seed(seed)
    Z_train = train_data['Z']
    U_train = train_data['U']
    De_train = train_data['De']
...
def SUPstat1(train_data,test_data,Z_2_test,n_lr,k=5,n_layer=3,n_node=64,n_epoch=200,seed=1924):  
    set_seed(seed)
    #1.basic set-ups
    Z_train = train_data['Z']
    U_train = train_data['U']
...
def SUPtest1(train_data,test_data,alpha=0.05,n_lr=4e-4,n_layer=3,n_node=64,n_epoch=200,k=5,B=50,seed=1924):
    set_seed(seed)
    Z_train = train_data['Z']
    U_train = train_data['U']
    De_train = train_data['De']
