...
B = 200 
test_data = generate_case_3(200, corr, Beta)
X_test = test_data['X']
...
plt.ylim(-2,2) 
ax1_1.set_title("Case 3, n=500",fontsize=10) 
...
plt.ylim(-2,2) 
ax1_2.set_title("Case 3, n=1000",fontsize=10)
...
plt.ylim(-2,2) 
ax1_3.set_title("Case 3, n=2000",fontsize=10)
...
plt.ylim(0,1) 
ax2_1.set_title("Case 3, n=500", fontsize=10)
...
plt.ylim(0,1) 
ax2_2.set_title("Case 3, n=1000", fontsize=10) 
...
plt.ylim(0,1) 
ax2_3.set_title("Case 3, n=2000", fontsize=10)
...
for i in range(len(Set_n)):
    ...
    for b in range(B):  #each result based on B repulication
        print('n=', n, 'b=', b)
        set_seed(12 + b)
        ...
        train_data = generate_case_3(n, corr, Beta)
        ...
        re_deep.append(np.sqrt(np.mean((Est_hat['g_test']-np.mean(Est_hat['g_test'])-g_true)**2)/np.mean(g_true**2))) #loss of g(x)
...
fig1.savefig('fig_g_3_t.jpeg', dpi=400, bbox_inches='tight')
fig2.savefig('fig_Lambda_3_t.jpeg', dpi=400, bbox_inches='tight')
...
result_error.to_csv('result_error_deep1_t.csv')
...
result_re.to_csv('result_re_deep1_t.csv')
