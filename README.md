...
This is the code of "Deep learning for the change-point Cox model with current status data." That is the beginning of my journey in deep learning.

Please run the MaintryXX.ipynb in Model_Linear1, Model_Add1 anf Model_Deep1 for evaluating the simulation results.
